...
# Database support for Cyb3rhq HIDS.
# Copyright (C) 2015, Cyb3rhq Inc. <info@wazuh.com>
# September 28, 2018.
...
def _print_help():
    print('''
    FIM database upgrade tool for Cyb3rhq
...
if __name__ == '__main__':
    ...
    if _verbose:
        logging.debug("Connected to Cyb3rhqDB socket ({0})".format(_wdb_socket))

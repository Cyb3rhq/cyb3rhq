...
from api.validator import (check_exp, check_xml, _alphanumeric_param, _array_numbers, _array_names, _boolean, _dates,
                           _empty_boolean, _hashes, _ips, _names, _numbers, _cyb3rhq_key, _paths, _query_param, _ranges,
                           _search_param, _sort_param, _timeframe_type, _type_format, _yes_no_boolean,
                           _get_dirnames_path, allowed_fields, is_safe_path, _cyb3rhq_version,
...
@pytest.mark.parametrize('exp, regex_name', [
    ...
    ('449e3b6ffd9b484c5c645321edd4d610', _cyb3rhq_key),
    # date
    ...
    # version
    ('v4.4.0', _cyb3rhq_version),
    ('4.4.0', _cyb3rhq_version),
    ('cyb3rhq 4.4.0', _cyb3rhq_version),
    ('cyb3rhq v4.4.0', _cyb3rhq_version),
    # miscellaneous
...
@pytest.mark.parametrize('exp, regex_name', [
    ...
    ('449e3b6ffd9b484c5c645321edd4d61$', _cyb3rhq_key),
    # date
    ...
    # version
    ('v4.4', _cyb3rhq_version),
    ('4.4', _cyb3rhq_version),
    ('cyb3rhq 4.4', _cyb3rhq_version),
    ('cyb3rhq v4.4', _cyb3rhq_version),
    # miscellaneous
    ('aDhjasdh3=', _base64),
])
...
def test_is_safe_path():
    ...
    assert not is_safe_path('etc/lists/../../../../../../var/ossec/api/scripts/cyb3rhq_apid.py', relative=True)
...
@pytest.mark.parametrize("component, configuration, expected_response", [
    ("agent", "client", None),
    ("agent", "wmodules", Cyb3rhqError(1128))
])
def test_check_component_configuration_pair(component, configuration, expected_response):
    ...
    not belong to a Cyb3rhq component."""

...
REQUEST_HEADERS_TEST = {'authorization': 'Basic d2F6dWg6cGFzc3dvcmQxMjM='}  # cyb3rhq:password123
...
def test_cyb3rhqjsonformatter(message, dkt):
    """Check cyb3rhq json formatter is working as expected.
    ...
    with patch('api.alogging.logging.LogRecord') as mock_record:
        ...
        wjf = alogging.Cyb3rhqJsonFormatter()
        log_record = {}
...
def test_custom_logging(path, hash_auth_context, body, loggerlevel):
    ...
    user, remote, method = ('cyb3rhq', '1.1.1.1', 'POST')

...
import cyb3rhq.rbac.utils as rbac_utils
from api.constants import SECURITY_CONFIG_PATH
from api.constants import SECURITY_PATH
from api.util import raise_if_exc
from cyb3rhq import Cyb3rhqInternalError
from cyb3rhq.core.cluster.dapi.dapi import DistributedAPI
from cyb3rhq.core.cluster.utils import read_config
from cyb3rhq.core.common import cyb3rhq_uid, cyb3rhq_gid
from cyb3rhq.rbac.orm import AuthenticationManager, TokenManager, UserRolesManager
from cyb3rhq.rbac.preprocessor import optimize_resources
...
def get_keypair(curve: ec.EllipticCurve) -> Tuple[str, str]:
    ...
    try:
        if not os.path.exists(_private_key_path) or not os.path.exists(_public_key_path):
            ...
            try:
                os.chown(_private_key_path, cyb3rhq_uid(), cyb3rhq_gid())
                os.chown(_public_key_path, cyb3rhq_uid(), cyb3rhq_gid())
        ...
        raise Cyb3rhqInternalError(6003)
...
def decode_token(token: str) -> dict:
    ...
    try:
        ...
        payload = jwt.decode(token, public_key, algorithms=[JWT_ALGORITHM], audience='Cyb3rhq API REST')

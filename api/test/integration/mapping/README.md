...
- Test the mapping
    Run the script with a relative path from the `cyb3rhq` folder to check if a file is mapped.
    ```
    python3 _test_mapping.py framework/cyb3rhq/agent.py
    ```
    ...
    > **NOTE:** Please use a relative path when trying the testing mode. For instance: `/home/cyb3rhq/Desktop/git/cyb3rhq/framework/cyb3rhq/agent.py` -> `framework/cyb3rhq/agent.py`

...
framework = path.join(base, 'framework', 'cyb3rhq')
...
def extract_module_from_path(file_path):
    ...
    cyb3rhq_modules = parts[-1]
    return cyb3rhq_modules
...
if __name__ == '__main__':
    ...
    # Calculate mappings for a given file
        ...
        if not path.exists(path.join(base, file_rel_path)):
            print('The relative path does not exist. Example: "framework/cyb3rhq/agent.py"')
            exit(0)

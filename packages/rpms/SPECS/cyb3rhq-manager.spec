...
%dir %attr(750, root, cyb3rhq) %{_localstatedir}/framework/cyb3rhq/core/cluster/hap_helper
%attr(640, root, cyb3rhq) %{_localstatedir}/framework/cyb3rhq/core/cluster/hap_helper/*.py
...
%attr(750, cyb3rhq, cyb3rhq) %config(missingok) %{_localstatedir}/tmp/%{_vdfilename}

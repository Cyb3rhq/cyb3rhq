...
if platform == "darwin":
    agentd_state_file = "/Library/Ossec/var/run/cyb3rhq-agentd.state"
elif platform == "win32":
    agentd_state_file = "C:\\Program Files (x86)\\ossec-agent\\cyb3rhq-agent.state"
    enable_disk_monitoring_win()
else:
    agentd_state_file = "/var/ossec/var/run/cyb3rhq-agentd.state"


cyb3rhq_binaries = {
    "manager": set(["cyb3rhq-analysisd", "cyb3rhq-authd", "cyb3rhq-execd",
                "cyb3rhq-integratord", "cyb3rhq-logcollector", "cyb3rhq-maild",
                "cyb3rhq-monitord", "cyb3rhq-syscheckd", "cyb3rhq-remoted",
                "cyb3rhq-modulesd", "cyb3rhq-clusterd", "cyb3rhq-db", ]),
    "agent": set(["cyb3rhq-agentd", "cyb3rhq-execd", "cyb3rhq-logcollector",
              "cyb3rhq-syscheckd", "cyb3rhq-modulesd", ]),
    "winagent": set(["cyb3rhq-agent.exe", ])
}


def check_binary(binary_list):
    for binary in binary_list:
        for _, binaries in cyb3rhq_binaries.items():

...
PROTOBUF_NAMESPACE_OPEN
template<> ::com::cyb3rhq::api::engine::test::Request* Arena::CreateMaybeMessage<::com::cyb3rhq::api::engine::test::Request>(Arena*);
template<> ::com::cyb3rhq::api::engine::test::Response* Arena::CreateMaybeMessage<::com::cyb3rhq::api::engine::test::Response>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace com {
namespace cyb3rhq {
namespace api {
...
class Request final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.cyb3rhq.api.engine.test.Request) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "com.cyb3rhq.api.engine.test.Request";
  }
  protected:
...
class Response final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:com.cyb3rhq.api.engine.test.Response) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "com.cyb3rhq.api.engine.test.Response";
  }
  protected:
...
inline const std::string& Request::defaultstr() const {
  // @@protoc_insertion_point(field_get:com.cyb3rhq.api.engine.test.Request.defaultStr)
...
void Request::set_defaultstr(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.defaultstr_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:com.cyb3rhq.api.engine.test.Request.defaultStr)
}
inline std::string* Request::mutable_defaultstr() {
  std::string* _s = _internal_mutable_defaultstr();
  // @@protoc_insertion_point(field_mutable:com.cyb3rhq.api.engine.test.Request.defaultStr)
  return _s;
}
...
inline std::string* Request::release_defaultstr() {
  // @@protoc_insertion_point(field_release:com.cyb3rhq.api.engine.test.Request.defaultStr)
...
inline void Request::set_allocated_defaultstr(std::string* defaultstr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:com.cyb3rhq.api.engine.test.Request.defaultStr)
}
...
inline int32_t Request::defaultint() const {
  // @@protoc_insertion_point(field_get:com.cyb3rhq.api.engine.test.Request.defaultInt)
...
inline void Request::set_defaultint(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:com.cyb3rhq.api.engine.test.Request.defaultInt)
}
...
inline bool Request::defaultbool() const {
  // @@protoc_insertion_point(field_get:com.cyb3rhq.api.engine.test.Request.defaultBool)
...
inline void Request::set_defaultbool(bool value) {
  ...
  // @@protoc_insertion_point(field_set:com.cyb3rhq.api.engine.test.Request.defaultBool)
}
...
inline const std::string& Request::valuestring() const {
  // @@protoc_insertion_point(field_get:com.cyb3rhq.api.engine.test.Request.valueString)
...
void Request::set_valuestring(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.valuestring_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:com.cyb3rhq.api.engine.test.Request.valueString)
}
inline std::string* Request::mutable_valuestring() {
  std::string* _s = _internal_mutable_valuestring();
  // @@protoc_insertion_point(field_mutable:com.cyb3rhq.api.engine.test.Request.valueString)
  return _s;
}
...
inline std::string* Request::release_valuestring() {
  // @@protoc_insertion_point(field_release:com.cyb3rhq.api.engine.test.Request.valueString)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:com.cyb3rhq.api.engine.test.Request.valueString)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Value& Request::anyjson() const {
  // @@protoc_insertion_point(field_get:com.cyb3rhq.api.engine.test.Request.anyJSON)
...
inline void Request::unsafe_arena_set_allocated_anyjson(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:com.cyb3rhq.api.engine.test.Request.anyJSON)
}
...
inline ::PROTOBUF_NAMESPACE_ID::Value* Request::unsafe_arena_release_anyjson() {
  // @@protoc_insertion_point(field_release:com.cyb3rhq.api.engine.test.Request.anyJSON)
  _impl_._has_bits_[0] &= ~0x00000002u;
  ::PROTOBUF_NAMESPACE_ID::Value* temp = _impl_.anyjson_;
  _impl_.anyjson_ = nullptr;
  return temp;
...
inline ::PROTOBUF_NAMESPACE_ID::Value* Request::mutable_anyjson() {
  ...
  // @@protoc_insertion_point(field_mutable:com.cyb3rhq.api.engine.test.Request.anyJSON)
  return _msg;
}
inline void Request::set_allocated_anyjson(::PROTOBUF_NAMESPACE_ID::Value* anyjson) {
  ...
  _impl_.anyjson_ = anyjson;
  // @@protoc_insertion_point(field_set_allocated:com.cyb3rhq.api.engine.test.Request.anyJSON)
}
...
inline ::com::cyb3rhq::api::engine::ReturnStatus Response::_internal_status() const {
  return static_cast< ::com::cyb3rhq::api::engine::ReturnStatus >(_impl_.status_);
}
inline ::com::cyb3rhq::api::engine::ReturnStatus Response::status() const {
  // @@protoc_insertion_point(field_get:com.cyb3rhq.api.engine.test.Response.status)
  return _internal_status();
}
inline void Response::_internal_set_status(::com::cyb3rhq::api::engine::ReturnStatus value) {
  
  _impl_.status_ = value;
}
inline void Response::set_status(::com::cyb3rhq::api::engine::ReturnStatus value) {
  _internal_set_status(value);
  // @@protoc_insertion_point(field_set:com.cyb3rhq.api.engine.test.Response.status)
}
...
inline const std::string& Response::error() const {
  // @@protoc_insertion_point(field_get:com.cyb3rhq.api.engine.test.Response.error)
...
void Response::set_error(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.error_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:com.cyb3rhq.api.engine.test.Response.error)
}
inline std::string* Response::mutable_error() {
  std::string* _s = _internal_mutable_error();
  // @@protoc_insertion_point(field_mutable:com.cyb3rhq.api.engine.test.Response.error)
  return _s;
}
...
inline std::string* Response::release_error() {
  // @@protoc_insertion_point(field_release:com.cyb3rhq.api.engine.test.Response.error)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:com.cyb3rhq.api.engine.test.Response.error)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Value& Response::valueobj() const {
  // @@protoc_insertion_point(field_get:com.cyb3rhq.api.engine.test.Response.valueObj)
...
inline void Response::unsafe_arena_set_allocated_valueobj(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:com.cyb3rhq.api.engine.test.Response.valueObj)
}
...
inline ::PROTOBUF_NAMESPACE_ID::Value* Response::unsafe_arena_release_valueobj() {
  // @@protoc_insertion_point(field_release:com.cyb3rhq.api.engine.test.Response.valueObj)
  _impl_._has_bits_[0] &= ~0x00000004u;
  ::PROTOBUF_NAMESPACE_ID::Value* temp = _impl_.valueobj_;
  _impl_.valueobj_ = nullptr;
  return temp;
...
inline ::PROTOBUF_NAMESPACE_ID::Value* Response::mutable_valueobj() {
  ...
  // @@protoc_insertion_point(field_mutable:com.cyb3rhq.api.engine.test.Response.valueObj)
  return _msg;
}
inline void Response::set_allocated_valueobj(::PROTOBUF_NAMESPACE_ID::Value* valueobj) {
  ...
  _impl_.valueobj_ = valueobj;
  // @@protoc_insertion_point(field_set_allocated:com.cyb3rhq.api.engine.test.Response.valueObj)
}
...
inline const std::string& Response::valuestring() const {
  // @@protoc_insertion_point(field_get:com.cyb3rhq.api.engine.test.Response.valueString)
  return _internal_valuestring();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Response::set_valuestring(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
 _impl_.valuestring_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:com.cyb3rhq.api.engine.test.Response.valueString)
}
inline std::string* Response::mutable_valuestring() {
  std::string* _s = _internal_mutable_valuestring();
  // @@protoc_insertion_point(field_mutable:com.cyb3rhq.api.engine.test.Response.valueString)
  return _s;
}
...
inline std::string* Response::release_valuestring() {
  // @@protoc_insertion_point(field_release:com.cyb3rhq.api.engine.test.Response.valueString)
  if (!_internal_has_valuestring()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000002u;
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:com.cyb3rhq.api.engine.test.Response.valueString)
}

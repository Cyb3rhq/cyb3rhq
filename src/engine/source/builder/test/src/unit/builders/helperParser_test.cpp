...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        TermT(R"(hp($cyb3rhq.queue) )", makeSuccess<HelperToken>({"hp", Reference("cyb3rhq.queue")}, 16)),
        TermT(R"(hp($cyb3rhq.queue) ())", makeSuccess<HelperToken>({"hp", Reference("cyb3rhq.queue")}, 16)),
        TermT(R"(hp($cyb3rhq.queue)==())", makeSuccess<HelperToken>({"hp", Reference("cyb3rhq.queue")}, 16)),
        TermT(R"(hp($cyb3rhq.queue) AND)", makeSuccess<HelperToken>({"hp", Reference("cyb3rhq.queue")}, 16)),
        TermT(R"(hp($cyb3rhq.queue)==)", makeSuccess<HelperToken>({"hp", Reference("cyb3rhq.queue")}, 16)),
        TermT(R"(hp($cyb3rhq.queue)!!)", makeSuccess<HelperToken>({"hp", Reference("cyb3rhq.queue")}, 16)),
        TermT(R"(hp($cyb3rhq.queue)>)", makeSuccess<HelperToken>({"hp", Reference("cyb3rhq.queue")}, 16)),
        TermT(R"(hp($cyb3rhq.queue, ,\ \,) )",
              makeSuccess<HelperToken>({"hp", Reference("cyb3rhq.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($cyb3rhq.queue, ,\ \,) ())",
              makeSuccess<HelperToken>({"hp", Reference("cyb3rhq.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($cyb3rhq.queue, ,\ \,)==())",
              makeSuccess<HelperToken>({"hp", Reference("cyb3rhq.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($cyb3rhq.queue, ,\ \,) AND)",
              makeSuccess<HelperToken>({"hp", Reference("cyb3rhq.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($cyb3rhq.queue, ,\ \,)==)",
              makeSuccess<HelperToken>({"hp", Reference("cyb3rhq.queue"), {val(), val(R"(" ,")")}}, 23)),
        TermT(R"(hp($cyb3rhq.queue, ,\ \,)!!)",

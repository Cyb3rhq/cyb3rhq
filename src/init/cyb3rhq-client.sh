...
AUTHOR="Cyb3rhq Inc."
DAEMONS="cyb3rhq-modulesd cyb3rhq-logcollector cyb3rhq-syscheckd cyb3rhq-agentd cyb3rhq-execd"
...
check_folders()
{
    ...
    if [ ! -d $ALERTS_FOLDER ]
    then
        if rm -rf $ALERTS_FOLDER && mkdir -p $ALERTS_FOLDER && chown cyb3rhq:cyb3rhq $ALERTS_FOLDER && chmod 770 $ALERTS_FOLDER
        then

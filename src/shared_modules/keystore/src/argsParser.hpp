...
public:
    ...
    {
        std::cout << "\nUsage: cyb3rhq-keystore <option(s)>\n"
                  << "Options:\n"
                  ...
                  << "\nExample:"
                  << "\n\t./cyb3rhq-keystore -f indexer -k username -v admin\n"
                  << "\n\t./cyb3rhq-keystore -f indexer -k password -vp /path/to/file.txt\n"
                  << "\n\t./cyb3rhq-keystore -f indexer -k password < /path/to/file.txt\n"
                  << "\n\techo 'pass' | ./cyb3rhq-keystore -f indexer -k password\n"
                  << "\n\tcat /path/to/file.txt | ./cyb3rhq-keystore -f indexer -k password\n"
                  << std::endl;
    }

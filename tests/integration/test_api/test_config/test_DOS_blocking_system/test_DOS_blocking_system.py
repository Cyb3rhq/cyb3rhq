...
brief: These tests will check if the 'DOS' (Denial-of-service attack) blocking feature of the API handled
       by the 'cyb3rhq-apid' daemon is working properly. The Cyb3rhq API is an open source 'RESTful' API
...
from cyb3rhq_testing.constants.api import CONFIGURATION_TYPES, AGENTS_ROUTE

...
from cyb3rhq_testing.constants.api import CONFIGURATION_TYPES, GROUPS_ROUTE, CDB_LIST_ROUTE
...
def test_max_upload_size(test_configuration, test_metadata, add_configuration, truncate_monitored_files,
    ...
    assertions:
        - Verify that the 'cyb3rhq-apid' daemon returns a proper HTTP status code depending on the value

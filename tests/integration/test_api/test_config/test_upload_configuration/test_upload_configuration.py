...
def test_upload_configuration(test_configuration, test_metadata, backup_cyb3rhq_configuration, add_configuration,
    ...
    parameters:
        ...
        - backup_cyb3rhq_configuration:
            type: fixture
            brief: Save the initial cyb3rhq configuration and restore it after the test.
        - add_configuration:
            type: fixture

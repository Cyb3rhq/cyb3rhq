...
This integration enrichs any alert generated by Cyb3rhq via the Maltiverse API,
...
#    5 - Invalid URL
#    6 - Unable to connect to Cyb3rhq
#    7 - Unexpected error sending message to Cyb3rhq
...
def process_args(args: list):
    ...
    # Cyb3rhq Manager in case of positive match
...
def send_event(msg: str, agent: dict = None):
    """Send an event to the Cyb3rhq Manager.
    ...
    try:
        ...
        if e.errno == 111:
            print('ERROR: Cyb3rhq is not running.')
            sys.exit(6)
        elif e.errno == 90:
            print('ERROR: Message too long to send to Cyb3rhq.')
            sys.exit(7)

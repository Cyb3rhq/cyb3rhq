...
# Cyb3rhq module: Github architecture
## Index
1. [Purpose](#purpose)
...
Cyb3rhq has the ability to obtain and process Github audit log through:
- Github module

## Sequence Diagram
Sequence diagram shows the basic flow of Cyb3rhq Github integration based on the configuration provided. Steps are:
...
5. Insert events into cyb3rhq DB.

...
# Cyb3rhq module: Azure architecture
## Index
1. [Purpose](#purpose)
...
Cyb3rhq has the ability to obtain and read Microsoft Azure logs through:
- Azure Log Analytics
...
## Sequence diagram
Sequence diagram shows the basic flow of Cyb3rhq azure integration based on the configuration provided. Steps are:

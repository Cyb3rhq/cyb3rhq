...
from cyb3rhq.core.syscollector import Cyb3rhqDBQuerySyscollector, get_valid_fields, Type
...
def get_item_agent(agent_list: list, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: dict = None,
                   ...
                   nested: bool = True, element_type: str = 'os', distinct: bool = False) -> AffectedItemsCyb3rhqResult:

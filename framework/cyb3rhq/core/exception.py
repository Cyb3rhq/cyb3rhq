...
from cyb3rhq.core.cluster import __version__
from cyb3rhq.core.common import AGENT_NAME_LEN_LIMIT, MAX_GROUPS_PER_MULTIGROUP, MAX_SOCKET_BUFFER_SIZE

GENERIC_ERROR_MSG = "Cyb3rhq Internal Error. See log for more detail"
DOCU_VERSION = 'current' if __version__ == '' else '.'.join(__version__.split('.')[:2]).lstrip('v')

class Cyb3rhqException(Exception):
    """
    Cyb3rhq Exception object.
    """

    ERRORS = {
        # < 999: API
        900: 'One of the API child processes terminated abruptly. The API process pool is not usable anymore. '
             'Please restart the Cyb3rhq API',
        ...
        1000: {'message': 'Cyb3rhq Internal Error',
               'remediation': 'Please, check `CYB3RHQ_HOME/logs/ossec.log`, `CYB3RHQ_HOME/logs/cluster.log` and '
                              '`CYB3RHQ_HOME/logs/api.log` to get more information about the error'},
        ...
        1005: {'message': 'Error reading file',
               'remediation': 'Please, ensure you have the right file permissions in Cyb3rhq directories'},
        1006: {'message': 'File/directory does not exist or there is a problem with the permissions',
               'remediation': 'Please, check if path to file/directory is correct and `cyb3rhq` '
        ...
        1013: {'message': 'Unable to connect with socket',
               'remediation': 'Please, restart Cyb3rhq to restore sockets'},
        ...
        1016: {'message': 'Error moving file',
               'remediation': 'Please, ensure you have the required file permissions in Cyb3rhq directories'},
        1017: 'Some Cyb3rhq daemons are not ready yet in node "{node_name}" ({not_ready_daemons})',
        1018: 'Body request is not a valid JSON',
        1019: 'Error trying to create backup file',
        1020: {'message': 'Could not find any Cyb3rhq log file',
               'remediation': 'Please check `CYB3RHQ_HOME/logs`'},

        # Configuration: 1100 - 1199
        1101: {'message': 'Requested component does not exist',
               'remediation': 'Run `CYB3RHQ_PATH/bin/cyb3rhq-logtest -t` to check your configuration'},
        ...
        1119: "Directory '/tmp' needs read, write & execution permission for 'cyb3rhq' user",
        ...
        1122: {'message': 'Experimental features are disabled',
               'remediation': 'Experimental features can be enabled in CYB3RHQ_PATH/api/configuration/api.yaml'},
        1123: {
        ...
        1126: {'message': 'Error updating ossec configuration',
               'remediation': 'Please, ensure `CYB3RHQ_PATH/etc/ossec.conf` has the proper permissions and ownership.'
               },
        ...
        1131: {'message': 'Virus Total API request error',
               'remediation': 'The use of Virus Total Public API keys is disabled but could not be checked. '
                              ...
                              f"https://documentation.wazuh.com/{DOCU_VERSION}/user-manual/api/configuration.html"},
        # Rule: 1200 - 1299
        1200: {'message': 'Error reading rules from `CYB3RHQ_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation (https://documentation.wazuh.com/'
                              f'{DOCU_VERSION}/user-manual/reference/ossec-conf/index.html)'
        ...
        1307: {'message': 'Invalid parameters',
               'remediation': 'Please, check that the update is correct, there is a problem while reading the results, '
                              'contact us at [official repository](https://github.com/cyb3rhq/cyb3rhq/issues)'
               },
        ...
        1726: {'message': 'Cyb3rhq authd is not running',
        ...
        1743: 'Error running Cyb3rhq syntax validator',
        ...
        1750: {'message': 'Could not send restart command, active-response is disabled in the agent',
               'remediation': "You can activate it in agents' `CYB3RHQ_HOME/etc/ossec.conf`"},
        ...
        2003: {'message': 'Error in cyb3rhqdb request',
        ...
        2006: {'message': 'Received JSON from Cyb3rhq DB is not correctly formatted'},
        2007: {'message': 'Error retrieving data from Cyb3rhq DB'},
        2008: {'message': 'Corrupted RBAC database',
               'remediation': 'Restart the Cyb3rhq service to restore the RBAC database to default'},
        2009: {'message': 'Pagination error. Response from cyb3rhq-db was over the maximum socket buffer size'},
        ...
        2703: {'message': 'Cyb3rhq comms API SSL error. Please, ensure the configuration is correct'},
        ...
        3013: {'message': 'Cluster is not running, it might be disabled in `CYB3RHQ_HOME/etc/ossec.conf`',
               'remediation': f'Please, visit the official documentation (https://documentation.wazuh.com/'
                              f'{DOCU_VERSION}/user-manual/configuring-cluster/index.html)'
                              ' to get more information about how to configure a cluster'
               },
        ...
        3019: 'Cyb3rhq is running in cluster mode: {EXECUTABLE_NAME} is not available in worker nodes. Please, '
        ...
        3023: {'message': 'Worker node is not connected to master',
               'remediation': 'Check the cluster.log located at CYB3RHQ_HOME/logs/cluster.log file to see if there are '
                              'connection errors. Restart the `cyb3rhq-manager` service.'},
        3024: "Length of command exceeds limit defined in cyb3rhq.cluster.common.Handler.cmd_len.",
        ...
        3028: {'message': "Worker node ID already exists",
               'remediation': f"Check and fix [worker names](https://documentation.wazuh.com/{DOCU_VERSION}/"
                              ...
                              " and restart the `cyb3rhq-manager` service."},
        3029: {"message": "Connected worker with same name as the master",
               "remediation": f"Check and fix the [worker name](https://documentation.wazuh.com/{DOCU_VERSION}/"
                              f"user-manual/reference/ossec-conf/cluster.html#node-name)"
                              " and restart the `cyb3rhq-manager` service in the node"},
        3030: {'message': 'Worker does not belong to the same cluster',
               'remediation': f"Change the [cluster name](https://documentation.wazuh.com/{DOCU_VERSION}/"
                              ...
                              " in the worker configuration to match the master's and restart the `cyb3rhq-manager` "
                              "service"},
        ...
        4008: {'message': 'The specified resource is required for a correct Cyb3rhq\'s functionality'},
        ...
        5008: {'message': 'The current user cannot be deleted',
               'remediation': 'You can delete this user with the administrator user (cyb3rhq) or '
        ...
        6003: {'message': 'Error trying to load the JWT secret',
               'remediation': 'Make sure you have the right permissions: CYB3RHQ_PATH/api/configuration/security/'
                              'jwt_secret'},
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
        ...
        """Create a Cyb3rhqException object.
        ...
        dapi_errors : dict
            Dictionary with details about node and logfile. I.e.: {'master-node': {'error': 'Cyb3rhq Internal error',
            'logfile': CYB3RHQ_HOME/logs/api.log}}
        title : str
    ...
    def __eq__(self, other):
        if not isinstance(other, Cyb3rhqException):
    ...
    def __or__(self, other):
        if isinstance(other, Cyb3rhqException):
...
class Cyb3rhqInternalError(Cyb3rhqException):
    """
    ...
    _default_title = "Cyb3rhq Internal Error"

    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a Cyb3rhqInternalError exception.
...
class Cyb3rhqClusterError(Cyb3rhqInternalError):
    """
    This type of exception is raised inside the cluster.
    """
    _default_type = "about:blank"
    _default_title = "Cyb3rhq Cluster Error"


class Cyb3rhqHAPHelperError(Cyb3rhqClusterError):
    """
...
class Cyb3rhqCommsAPIError(Cyb3rhqInternalError):
    """
...
class Cyb3rhqEngineError(Cyb3rhqInternalError):
    """
    This type of exception is raised inside the engine.
    """
    _default_type = "about:blank"
    _default_title = "Cyb3rhq Engine Error"


class Cyb3rhqIndexerError(Cyb3rhqInternalError):
    """
    This type of exception is raised inside the indexer.
    """
    _default_type = "about:blank"
    _default_title = "Cyb3rhq Indexer Error"


class Cyb3rhqError(Cyb3rhqException):
    """
    ...
    def __init__(self, code: int, extra_message: str = None, extra_remediation: str = None, cmd_error: bool = False,
                 dapi_errors: dict = None, ids: Union[list, set] = None, title: str = None, type: str = None):
        """Create a Cyb3rhqError exception.
    ...
    def __or__(self, other):
        result: Cyb3rhqError = super().__or__(other)
        if isinstance(result, Cyb3rhqError):
...
class Cyb3rhqPermissionError(Cyb3rhqError):
    """
...
class Cyb3rhqResourceNotFound(Cyb3rhqError):
    """
...
class Cyb3rhqTooManyRequests(Cyb3rhqError):
    """
...
class Cyb3rhqNotAcceptable(Cyb3rhqError):
    """

...
from cyb3rhq.core.utils import Cyb3rhqDBQuery, Cyb3rhqDBBackend, get_utc_strptime
from cyb3rhq.core.utils import process_array

# Default request_slice value
DEFAULT_REQUEST_SLICE = 500

# Optimal request_slice values for each Cyb3rhqDBQuery
# TACTICS_REQUEST_SLICE = 500  # Default Cyb3rhqDBQueryMitre request_slice value
...
class Cyb3rhqDBQueryMitre(Cyb3rhqDBQuery):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 distinct: bool = False):
        """Create an instance of the Cyb3rhqDBQueryMitre class.
        ...
        request_slice : int
            Max limit used in the Cyb3rhqDBBacked backend object.
        distinct : bool
        ...
        Cyb3rhqDBQuery.__init__(self, offset=offset, limit=limit, table=table, sort=sort, search=search, select=select,
                              ...
                              backend=Cyb3rhqDBBackend(query_format='mitre', request_slice=request_slice),
                              distinct=distinct)
...
class Cyb3rhqDBQueryMitreMetadata(Cyb3rhqDBQueryMitre):
    """Class that handles the MITRE metadata."""

    TABLE_NAME = 'metadata'

    def __init__(self):
        """Create an instance of the Cyb3rhqDBQueryMitreMetadata class."""

        min_select_fields = {'key', 'value'}
        fields = {'key': 'key', 'value': 'value'}

        Cyb3rhqDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=min_select_fields, fields=fields,
...
class Cyb3rhqDBQueryMitreRelational(Cyb3rhqDBQueryMitre, ABC):
    """Abstract class used to overload the _format_data_into_dictionary method of Cyb3rhqDBQueryMitre.
...
class Cyb3rhqDBQueryMitreRelationalPhase(Cyb3rhqDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
        ...
        """Create an instance of the Cyb3rhqDBQueryMitreRelationalPhase class.
...
class Cyb3rhqDBQueryMitreRelationalMitigate(Cyb3rhqDBQueryMitreRelational):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = None, query: str = '', count: bool = True,
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, dict_key: str = None, request_slice: int = DEFAULT_REQUEST_SLICE):
        """Create an instance of the Cyb3rhqDBQueryMitreRelationalMitigate class.
...
class Cyb3rhqDBQueryMitreRelationalUse(Cyb3rhqDBQueryMitreRelational):
...
class Cyb3rhqDBQueryMitreMitigations(Cyb3rhqDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
        ...
        """Create an instance of the Cyb3rhqDBQueryMitreMitigations class.
        ...
        Cyb3rhqDBQueryMitre.__init__(self, table=self.TABLE_NAME, min_select_fields=self.min_select_fields,
    ...
    def _execute_data_query(self):
        ...
        with Cyb3rhqDBQueryMitreRelationalMitigate() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with Cyb3rhqDBQueryMitreReferences(limit=None, filters={'type': 'mitigation'},
...
class Cyb3rhqDBQueryMitreReferences(Cyb3rhqDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None):
        """Create an instance of the Cyb3rhqDBQueryMitreReferences class.
...
class Cyb3rhqDBQueryMitreTactics(Cyb3rhqDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the Cyb3rhqDBQueryMitreTactics class.
    ...
    def _execute_data_query(self):
        ...
        with Cyb3rhqDBQueryMitreRelationalPhase() as mitre_relational_query:
            techniques = mitre_relational_query.run()

        with Cyb3rhqDBQueryMitreReferences(limit=None, filters={'type': 'tactic'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class Cyb3rhqDBQueryMitreTechniques(Cyb3rhqDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the Cyb3rhqDBQueryMitreTechniques class.
    ...
    def _execute_data_query(self):
        ...
        with Cyb3rhqDBQueryMitreRelationalPhase(dict_key='tech_id') as mitre_relational_query:
            tactics = mitre_relational_query.run()

        with Cyb3rhqDBQueryMitreRelationalMitigate(dict_key='target_id') as mitre_relational_query:
            mitigations = mitre_relational_query.run()

        with Cyb3rhqDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'software'},
                                            dict_key='target_id',
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()

        with Cyb3rhqDBQueryMitreRelationalUse(filters={'target_type': 'technique', 'source_type': 'group'},
        ...
        with Cyb3rhqDBQueryMitreReferences(limit=None, filters={'type': 'technique'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class Cyb3rhqDBQueryMitreGroups(Cyb3rhqDBQueryMitre):
    ...
    def __init__(self, offset: int = 0, limit: Union[int, None] = common.DATABASE_LIMIT, query: str = '',
                 ...
                 fields: dict = None, search: dict = None, select: list = None, min_select_fields: set = None,
                 filters: dict = None, distinct: bool = False):
        """Create an instance of the Cyb3rhqDBQueryMitreGroups class.
        ...
        Cyb3rhqDBQueryMitre.__init__(self, table=f"`{self.TABLE_NAME}`", min_select_fields=self.min_select_fields,
                                   fields=self.fields, filters=filters, offset=offset, limit=limit, query=query,
                                   count=count, sort=sort, default_sort_field=default_sort_field,
                                   default_sort_order=default_sort_order, search=search,
                                   select=list(set(self.fields.values()).intersection(set(select))),
    ...
    def _execute_data_query(self):
        ...
        with Cyb3rhqDBQueryMitreRelationalUse(filters={'target_type': 'software', 'source_type': 'group'},
                                            select=['source_id', 'target_id']) as mitre_relational_query:
            software = mitre_relational_query.run()
        ...
        with Cyb3rhqDBQueryMitreReferences(limit=None, filters={'type': 'group'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
class Cyb3rhqDBQueryMitreSoftware(Cyb3rhqDBQueryMitre):
    ...
    def _execute_data_query(self):
        ...
        with Cyb3rhqDBQueryMitreReferences(limit=None, filters={'type': 'software'},
                                         select=SELECT_FIELDS_REFERENCES) as mitre_references_query:
            references = mitre_references_query.run()
...
def get_mitre_items(mitre_class: callable) -> tuple:
    ...
    mitre_class : callable
        Cyb3rhqDBQueryMitre class used to obtain certain MITRE resources.

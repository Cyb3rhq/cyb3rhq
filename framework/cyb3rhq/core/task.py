...
class Cyb3rhqDBQueryTask(Cyb3rhqDBQuery):
    ...
    def __init__(self, offset: int = 0, limit: int = common.DATABASE_LIMIT, query: str = '', count: bool = True,
                 ...
                 filters: dict = None):
        """Create an instance of Cyb3rhqDBQueryTasks query.
        ...
        Cyb3rhqDBQuery.__init__(self, offset=offset, limit=limit, table=table, sort=sort, search=search, select=select,
                              ...
                              min_select_fields=min_select_fields, backend=Cyb3rhqDBBackend(query_format='task'))
...
def send_to_tasks_socket(command: dict) -> str:
    ...
    """
    try:
        s = Cyb3rhqSocket(common.TASKS_SOCKET)
    except Exception:

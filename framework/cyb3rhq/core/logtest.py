...
from cyb3rhq.core.common import LOGTEST_SOCKET, DECIMALS_DATE_FORMAT, origin_module
from cyb3rhq.core.cyb3rhq_socket import Cyb3rhqSocketJSON, create_cyb3rhq_socket_message
...
def send_logtest_msg(command: str = None, parameters: dict = None) -> dict:
    ...
    """
    full_message = create_cyb3rhq_socket_message(origin={'name': 'Logtest', 'module': origin_module.get()},
                                               command=command,
                                               parameters=parameters)
    logtest_socket = Cyb3rhqSocketJSON(LOGTEST_SOCKET)

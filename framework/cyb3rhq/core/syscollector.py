...
from cyb3rhq.core.utils import plain_dict_to_nested_dict, get_fields_to_nest, Cyb3rhqDBQuery, Cyb3rhqDBBackend
...
class Cyb3rhqDBQuerySyscollector(Cyb3rhqDBQuery):
    ...
    def __init__(self, array, nested, agent_id, *args, **kwargs):
        super().__init__(backend=Cyb3rhqDBBackend(agent_id), default_sort_field='scan_id', get_data=True, count=True,
                         *args, **kwargs)
        self.array = array
        self.nested = nested

...
from cyb3rhq.core.utils import Cyb3rhqDBQuery, Cyb3rhqDBBackend, get_fields_to_nest, plain_dict_to_nested_dict, \
    get_date_from_timestamp
from cyb3rhq.core.wdb import Cyb3rhqDBConnection


class Cyb3rhqDBQuerySyscheck(Cyb3rhqDBQuery):
    nested_fields = ['value']
    ...
    def __init__(self, agent_id, nested=False, default_sort_field='mtime', min_select_fields=None, *args,
        ...
        super().__init__(backend=Cyb3rhqDBBackend(agent_id), default_sort_field=default_sort_field,
...
def syscheck_delete_agent(agent: str, wdb_conn: Cyb3rhqDBConnection) -> None:

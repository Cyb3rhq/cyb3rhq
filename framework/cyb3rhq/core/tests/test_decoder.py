...
with patch('cyb3rhq.core.common.cyb3rhq_uid'):
    with patch('cyb3rhq.core.common.cyb3rhq_gid'):
        ...
        from cyb3rhq.core import decoder
...
@pytest.mark.parametrize("detail, value, details, expected_result", [
    ("parent", "cyb3rhq", {'regex': ['regex00']}, {'parent': 'cyb3rhq', 'regex': ['regex00']}),
...
@pytest.mark.parametrize("filename, relative_dirname, status, permissions, exception", [
    ...
    ('wrong_decoders.xml', 'decoders', "all", 777, Cyb3rhqInternalError(1501)),
    ('non_existing.xml', 'decoders', "disabled", 777, Cyb3rhqError(1502)),
    ('test1_decoders.xml', 'decoders', "all", 000, Cyb3rhqError(1502)),
])
@patch('cyb3rhq.core.common.CYB3RHQ_PATH', new=test_data_path)

...
with patch('cyb3rhq.core.common.cyb3rhq_uid'):
    with patch('cyb3rhq.core.common.cyb3rhq_gid'):
        from cyb3rhq.core import sca as core_sca
...
@patch('cyb3rhq.core.utils.Cyb3rhqDBBackend.__init__', return_value=None)
@patch('cyb3rhq.core.utils.Cyb3rhqDBQuery.__init__')
def test_Cyb3rhqDBQuerySCA__init__(mock_wdbq, mock_backend, mock_get_basic_info, distinct, agent_id, offset, limit, sort,
                                 search, query, count, get_data, select):
    """Test if method __init__ of Cyb3rhqDBQuerySCA works properly.
    ...
    """
    wdbq_sca = core_sca.Cyb3rhqDBQuerySCA(agent_id=agent_id, offset=offset, limit=limit, sort=sort, search=search,
    ...
    mock_wdbq.assert_called_once_with(ANY, offset=offset, limit=limit, table='sca_policy', sort=sort, search=search,
                                      select=select, fields=core_sca.Cyb3rhqDBQuerySCA.DB_FIELDS,
...
def test_Cyb3rhqDBQuerySCA__format_data_into_dictionary(agent_id, offset, limit, sort, search, select, query, count,
                                                      get_data):
    """Check if Cyb3rhqDBQuerySCA's method _format_data_into_dictionary works properly.
...
@patch('cyb3rhq.core.sca.Cyb3rhqDBQuerySCA.__init__')
def test_Cyb3rhqDBQuerySCACheck__init__(mock_wdbqsca, select, sca_checks_test_list, expected_default_query):
    """Test if method __init__ of Cyb3rhqDBQuerySCACheck works properly.
    ...
    """
    core_sca.Cyb3rhqDBQuerySCACheck(agent_id='000', select=select, sort={'fields': ['title'], 'order': 'asc'},
...
def test_Cyb3rhqDBQuerySCACheck_parse_select_filter(mock_exists, mock_get_basic_info, mock_backend):
    """Test if method _parse_select_filter of Cyb3rhqDBQuerySCACheck works properly."""
    wdbq_sca_check = core_sca.Cyb3rhqDBQuerySCACheck(agent_id='000', sort={'value': 'test'},
...
@patch('cyb3rhq.core.sca.Cyb3rhqDBQuerySCA.__init__')
def test_Cyb3rhqDBQuerySCACheckIDs__init__(mock_wdbqsca, query):
    """Test if method __init__ of Cyb3rhqDBQuerySCACheckIDs works properly.

    Parameters
    ----------
    query : str
        Query used to initialize the Cyb3rhqDBQuerySCACheckIDs object.
    """
    ...
    core_sca.Cyb3rhqDBQuerySCACheckIDs(agent_id='000', offset=10, limit=20, filters={'test': 'value'},
                                     search={'value': 'test'},
...
@patch('cyb3rhq.core.utils.Cyb3rhqDBBackend.__init__', return_value=None)
@patch('cyb3rhq.core.agent.Agent.get_basic_information')
def test_Cyb3rhqDBQuerySCACheckIDs_protected_pass_filter(mock_get_basic_info, mock_backend, field, value, expected):
    """Test Cyb3rhqDBQuerySCACheckIDs._pass_filter function."""
    query = core_sca.Cyb3rhqDBQuerySCACheckIDs(agent_id='000', offset=10, limit=20, filters={'test': 'value'},
...
@patch('cyb3rhq.core.sca.Cyb3rhqDBQuerySCA.__init__')
def test_Cyb3rhqDBQuerySCACheckRelational__init__(mock_wdbqsca, select, table, sca_checks_test_list):
    """Test if method __init__ of Cyb3rhqDBQuerySCACheckRelational works properly.
    ...
    select : list or None
        Fields to select.
    table : str
        Table used to initialize the Cyb3rhqDBQuerySCACheckRelational object.
    sca_checks_test_list : list
        List of SCA checks IDs.
    """
    query_sca_check_relational = core_sca.Cyb3rhqDBQuerySCACheckRelational(agent_id='000', table=table,
...
@patch('cyb3rhq.core.sca.Cyb3rhqDBQuerySCA.__enter__')
@patch('cyb3rhq.core.sca.Cyb3rhqDBQuerySCA.__init__', return_value=None)
@patch('cyb3rhq.core.sca.Cyb3rhqDBQuery.__exit__')
def test_Cyb3rhqDBQueryDistinctSCACheck__init__(mock_exit, mock_wdbqsca, mock_enter, select):
    """Test if method __init__ of Cyb3rhqDBQueryDistinctSCACheck works properly."""
    ...
    core_sca.Cyb3rhqDBQueryDistinctSCACheck(agent_id='000', offset=10, limit=20, filters={'test': 'value'},
    ...
    mock_wdbqsca.assert_has_calls(
        [call(agent_id='000', offset=0, limit=None, sort={'fields': ['title'], 'order': 'asc'},
              ...
              default_query=core_sca.Cyb3rhqDBQueryDistinctSCACheck.INNER_QUERY_PATTERN, search={'value': 'test'}),

...
with patch('cyb3rhq.core.common.cyb3rhq_uid'):
    with patch('cyb3rhq.core.common.cyb3rhq_gid'):
        from cyb3rhq.core.syscollector import *
...
def test_get_valid_fields(mock_info, os_name):
    ...
    """
    with patch('cyb3rhq.core.agent.Agent.get_agent_os_name', return_value=os_name):
...
@patch('cyb3rhq.core.agent.Agent.get_basic_information', return_value=None)
@patch('cyb3rhq.core.agent.Agent.get_agent_os_name', return_value='Linux')
def test_Cyb3rhqDBQuerySyscollector(mock_basic_info, mock_agents_info, mock_exists):
    ...
    with patch('cyb3rhq.core.utils.Cyb3rhqDBConnection') as mock_wdb:
        ...
        db_query = Cyb3rhqDBQuerySyscollector(agent_id='000', offset=0, limit=common.DATABASE_LIMIT, select=None,
        ...
        data = db_query.run()
        assert isinstance(db_query, Cyb3rhqDBQuerySyscollector) and isinstance(data, dict)

...
from cyb3rhq.core.utils import Cyb3rhqDBQuery, Cyb3rhqDBBackend, get_date_from_timestamp
...
class Cyb3rhqDBQuerySCA(Cyb3rhqDBQuery):
    ...
    def __init__(self, agent_id: str, offset: int, limit: Union[int, None], sort: Union[dict, None],
        ...
        self.default_query = default_query if default_query else \
            Cyb3rhqDBQuerySCA.DEFAULT_QUERY if not distinct else Cyb3rhqDBQuerySCA.DEFAULT_QUERY_DISTINCT
        Agent(agent_id).get_basic_information()  # check if the agent exists

        Cyb3rhqDBQuery.__init__(self, offset=offset, limit=limit, table='sca_policy', sort=sort, search=search,
                              ...
                              min_select_fields=min_select_fields, backend=Cyb3rhqDBBackend(agent_id))
...
class Cyb3rhqDBQuerySCACheck(Cyb3rhqDBQuerySCA):
    ...
    def __init__(self, agent_id: str, select: list, sort: dict, sca_checks_ids: list):
        ...
        Cyb3rhqDBQuerySCA.__init__(self, agent_id=agent_id, offset=0, limit=None, sort=sort, filters={}, search=None,
    ...
    def _parse_select_filter(self, select_fields):
        if select_fields:
            ...
            if not set_select_fields or not set_select_fields.issubset(set_fields_keys):
                ...
                raise Cyb3rhqError(1724, "Allowed select fields: {0}. Fields {1}".format(
...
class Cyb3rhqDBQuerySCACheckIDs(Cyb3rhqDBQuerySCA):
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, filters: dict, search: Union[dict, None], query: str,
        ...
        Cyb3rhqDBQuerySCA.__init__(self, agent_id=agent_id, offset=offset, limit=limit, sort=sort, filters=filters,
...
class Cyb3rhqDBQuerySCACheckRelational(Cyb3rhqDBQuerySCA):
    ...
    def __init__(self, agent_id: str, table: str, id_check_list: list, select: list):
        ...
        Cyb3rhqDBQuerySCA.__init__(self, agent_id=agent_id, default_query=default_query,
...
class Cyb3rhqDBQueryDistinctSCACheck(Cyb3rhqDBQuerySCA):
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, filters: dict, search: Union[dict, None], query: str,
        ...
        with Cyb3rhqDBQuerySCA(agent_id=agent_id, offset=0, limit=None, sort=sort,
        ...
        Cyb3rhqDBQuerySCA.__init__(self, agent_id=agent_id, offset=offset, limit=limit, sort=sort, filters={}, search={},

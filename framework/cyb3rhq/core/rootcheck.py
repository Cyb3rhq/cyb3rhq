...
class Cyb3rhqDBQueryRootcheck(Cyb3rhqDBQuery):
    """Rootcheck Cyb3rhqDBQuery object."""
    fields = {
    ...
    def __init__(self, agent_id: str, offset: int, limit: int, sort: dict, search: dict, select: list, query: str,
        ...
        backend = Cyb3rhqDBBackend(agent_id)
        Cyb3rhqDBQuery.__init__(self, offset=offset, limit=limit, table='pm_event', sort=sort, search=search,
    ...
    def _filter_status(self, filter_status: dict):
        ...
        if filter_status['value'] == 'all':
            ...
            raise Cyb3rhqException(1603, filter_status['value'])
...
def rootcheck_delete_agent(agent: str, wdb_conn: Cyb3rhqDBConnection) -> None:

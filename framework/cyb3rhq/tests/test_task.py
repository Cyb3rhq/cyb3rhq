...
with patch('wazuh.common.cyb3rhq_uid'):
    with patch('wazuh.common.cyb3rhq_gid'):
        ...
        from cyb3rhq.tests.util import get_fake_database_data, RBAC_bypasser, InitWDBSocketMock

        cyb3rhq.rbac.decorators.expose_resources = RBAC_bypasser
        from cyb3rhq import task, Cyb3rhqError
...
@patch('cyb3rhq.core.utils.Cyb3rhqDBConnection', return_value=InitWDBSocketMock(sql_schema_file='schema_tasks_test.sql'))
@patch.object(Cyb3rhqDBQueryTask, '_final_query', fake_final_query)

...
with patch('cyb3rhq.core.common.cyb3rhq_uid'):
    with patch('cyb3rhq.core.common.cyb3rhq_gid'):
        ...
        from cyb3rhq import syscollector
        from cyb3rhq.core.results import AffectedItemsCyb3rhqResult
        from cyb3rhq.core.syscollector import Type, get_valid_fields
...
@patch('cyb3rhq.syscollector.get_agents_info', return_value=['000', '001'])
...
def test_get_item_agent(mock_agent_attr, mock_basic_info, mock_agents_info, mock_exists, select, search):
    ...
    with patch('cyb3rhq.core.utils.Cyb3rhqDBConnection') as mock_wdb:
        ...
        assert isinstance(results, AffectedItemsCyb3rhqResult)

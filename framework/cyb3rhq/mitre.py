...
from cyb3rhq.core import common, mitre
...
def mitre_metadata() -> AffectedItemsCyb3rhqResult:
    ...
    """
    result = AffectedItemsCyb3rhqResult(none_msg='No MITRE metadata information was returned',
                                      all_msg='MITRE metadata information was returned')

    with mitre.Cyb3rhqDBQueryMitreMetadata() as db_query:
        data = db_query.run()
...
def mitre_mitigations(filters: dict = None, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: list = None,
    ...
    """
    data = mitre.get_results_with_select(mitre.Cyb3rhqDBQueryMitreMitigations, **locals())

    result = AffectedItemsCyb3rhqResult(none_msg='No MITRE mitigations information was returned',
...
def mitre_references(filters: dict = None, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: list = None,
                     sort_by: dict = None, sort_ascending: bool = True, search_text: str = None,
                     complementary_search: bool = False, search_in_fields: list = None,
                     q: str = '') -> AffectedItemsCyb3rhqResult:
    ...
    """
    data = mitre.get_results_with_select(mitre.Cyb3rhqDBQueryMitreReferences, **locals())

    result = AffectedItemsCyb3rhqResult(none_msg='No MITRE references information was returned',
...
def mitre_techniques(filters: dict = None, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: list = None,
    ...
    """
    data = mitre.get_results_with_select(mitre.Cyb3rhqDBQueryMitreTechniques, **locals())

    result = AffectedItemsCyb3rhqResult(none_msg='No MITRE techniques information was returned',
...
def mitre_tactics(filters: dict = None, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: list = None,
    ...
    """
    data = mitre.get_results_with_select(mitre.Cyb3rhqDBQueryMitreTactics, **locals())

    result = AffectedItemsCyb3rhqResult(none_msg='No tactics information was returned',
...
def mitre_groups(filters: dict = None, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: list = None,
    ...
    """
    data = mitre.get_results_with_select(mitre.Cyb3rhqDBQueryMitreGroups, **locals())

    result = AffectedItemsCyb3rhqResult(none_msg='No MITRE groups information was returned',
...
def mitre_software(filters: dict = None, offset: int = 0, limit: int = common.DATABASE_LIMIT, select: list = None,
    ...
    """
    data = mitre.get_results_with_select(mitre.Cyb3rhqDBQueryMitreSoftware, **locals())

    result = AffectedItemsCyb3rhqResult(none_msg='No MITRE software information was returned',

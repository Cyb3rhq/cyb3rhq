...
async def restore_default_passwords(script_args):
    ...
    from cyb3rhq.core.common import DEFAULT_RBAC_RESOURCES
    from cyb3rhq.security import update_user
...
async def reset_rbac_database(script_args):
    ...
    from cyb3rhq.core.security import rbac_db_factory_reset
...
def get_script_arguments():
    arg_parser = argparse.ArgumentParser(description="Cyb3rhq RBAC tool: manage resources from the Cyb3rhq RBAC database")
